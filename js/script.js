...
$(document).ready(function(){
		...
		if(apps == 'collapsed'){
			$('ul.nav-sidebar li').not('.head, li[data-id^="tag-"], li[data-id^="internal-bookmarks"], li[data-id="files_index"], li[data-id="trash"], li[data-id^="user-groups_"], li[data-id^="sharing_"], li[data-id^="owned-group-folders_"], li[data-id^="storage"]').hide();
